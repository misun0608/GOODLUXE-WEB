...
<head>
	...
	$(document).ready(function() {
		...
		console.log('총주문금액 ' + order_product_price);
		var delivery = <%=delivery_fee %>	// 배송비
		console.log('배송비 ' + delivery);
	
		$('#using_point').val('0');	// 적립금 사용
...
<body>
	...
	<section id="container">
		<br>
		<div id="main">
			<article class="arti_order_form">
				<br />
				<br />
				<h2 class="order_form_title">| 주문서 작성</h2>
				<br />
				<br />
				<br />
				<h3 class="order_form_title">주문내역</h3>
				<table class="about_order_table">
					<tr>
						<th class="order_title_td">이미지</th>
						<th>상품정보</th>
						<th>판매가</th>
						<th>적립금</th>
						<th>배송비</th>
					...
					<tr>
						<td class="order_title_td"><img
							src="${pageContext.request.contextPath}/resources/img/product/burberry_loafer.png"></td>
				...
				<br />
				<br />
				<h3 class="order_form_title">배송 정보</h3>
				<form action="./insertOrder.do" name="order_input_form" method="post">

					<table class="about_shipping_table">
						<tr>
							<td class="order_title_td">배송지 선택</td>
							<td>
								<input type="radio" name="location_radio" value="member_address" onclick="set_shipping_value()" checked>
								<label for="location_radio">회원 정보와 동일</label>
								<input type="radio" name="location_radio" value="new_address" onclick="reset_shipping_value()">
								<label for="location_radio">새로운 배송지</label>
							</td>
						</tr>
						<tr>
							<td class="order_title_td">받으시는 분 *</td>
							<td>
						...
						<tr>
							<td class="order_title_td">휴대전화 *</td>
						...
						<tr>
							<td class="order_title_td">이메일</td>
							<td class="grey_letter">
								<input type="text" id="order_email1" class="email1" name="email1" value="<%=member_email1%>" STYLE="ime-mode: inactive">
								&nbsp;&nbsp;@&nbsp;&nbsp; 
								<input type="text" id="order_email2" class="email2" name="email2" value="<%=member_email2%>" readonly="readOnly" size="10">
						...
						<tr>
							<td class="order_title_td">배송메세지</td>
					...
					<br />
					<br />
					<h3 class="order_form_title">할인 정보</h3>
					<table class="order_discount_table">
						<tr>
							<td class="order_title_td">쿠폰</td>
							<td>
					...
					<br />
					<br />
					<h3 class="order_form_title">결제 예정 금액</h3>
					<table class="about_pay_table">
						<tr>
							<td>총 주문 금액</td>
							<td>배송비</td>
							<td>적립금 사용</td>
						...
						<tr>
							<td>
								<input type="text" id="order_product_price" name="order_product_price" value="<%=sale_price %>" style="border:none; background: transparent;" dir="rtl"/>원
							</td>
							<td>
								+ <input type="text" id="order_ship_fee" name="order_ship_fee" value="<%=delivery_fee %>" style="border:none; background: transparent;" dir="rtl"/>원
							</td>
							<td>
							- <input type="text" name="order_used_point" id="using_point" style="border:none; background: transparent;" dir="rtl">원
							</td>
							<td>
							- <input type="text" id="using_coupon" readonly style="border:none; background: transparent;" dir="rtl">원
							</td>
							<td>
							= <input type="text" name="order_pay_price" id="final_price" readonly style="border:none; background: transparent;" dir="rtl">원
							</td>
						</tr>
					</table>
					<br /> <br />
					<h3 class="order_form_title">결제 수단</h3>
					<table class="about_checksys_table">
						<tr>
