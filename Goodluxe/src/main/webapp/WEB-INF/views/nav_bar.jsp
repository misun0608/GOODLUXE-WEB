<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nav_box.js"></script>
<div class="nav">
	<div class="nav_bg">
		<div class="nav_area">
			<div class="menubar">
				<ul class="menu">
					<li><a href="#">ALL BRAND</a>
						<ul class="submenu">
							<div>
								...
								<li><a href="./itemList.do?il_search_brand=Bottega Veneta">Bottega
										Veneta</a></li>
							...
							<div>
								<li><a href="./itemList.do?il_search_brand=Christian Dior">Christian
										Dior</a></li>
								<li><a
								...
								<li><a href="./itemList.do?il_search_brand=Dries Van Noten">Dries
										Van Noten</a></li>
							...
							<div>
								...
								<li><a href="./itemList.do?il_search_brand=Helen Kaminski">Helen
										Kaminski</a></li>
							...
							<div>
								...
								<li><a href="./itemList.do?il_search_brand=Louis Vuitton">Louis
										Vuitton</a></li>
								<li><a href="./itemList.do?il_search_brand=Manolo Blahnik">Manolo
										Blahnik</a></li>
							...
							<div>
								...
								<li><a
									href="./itemList.do?il_search_brand=Stella McCartney">Stella
										McCartney</a></li>
								<li><a href="./itemList.do?il_search_brand=Stuart Weitzman">Stuart
										Weitzman</a></li>
							...
							<div>
								...
								<li><a
									href="./itemList.do?il_search_brand=Vivienne westwood">Vivienne
										westwood</a></li>
								<li><a href="./itemList.do?il_search_brand=YSL Rive Gauche">YSL
										Rive Gauche</a></li>
					...
					<li><a href="./homeTT.do">EVENT</a></li>
				</ul>
				<ul class="search">
					<img
