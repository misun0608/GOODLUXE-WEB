...
<table style="width: 100%">
	<tr style="width: 100%;">
		<td>
			<div>
				<select name="" id="service_center_board_search"
					style="height: 27px; margin: 0px 0 9px 0;">
					<option value="#search_title">제목</option>
					<option value="#search_content">내용</option>
					<option value="#search_id">아이디</option>
				</select>
				<form action="" id="service_board_search_form"
		...
		<td style="float: right;"><a href="board_write.html"><button
					class="center_search_btn"
					style="width: 65px; height: 27px; margin-top: 2px;">글
					작성</button></a></td>
	</tr>
</table>
