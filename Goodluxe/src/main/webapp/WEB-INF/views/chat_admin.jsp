...
<head>
    ...
    <link rel="stylesheet" href="css/chat_view_admin.css" />
      ...
      <section class = "available">
        <div class = "screen_size screen_size_available">
            <div class = "chatting_header">
                ...
                <p class = "customer_id_info">jyeo3o 고객님</p>  
            </div>
            ...
            <div class = "make_text_file">
                <button>상담내용 저장하기.txt</button>
            </div>
        </div>
    </section>
