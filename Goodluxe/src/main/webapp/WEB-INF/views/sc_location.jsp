...
<table class="center_store_table" style="margin-top: 4px;">
	<tr class="service_center_middle_tr">
		<td
			style="width: 320px; font-weight: bold; color: rgb(100, 100, 100);">주
			소</td>
	...
	<tr class="service_center_middle_tr">
		<td
			style="height: 60px; font-weight: bold; color: rgb(100, 100, 100);">영업시간</td>
		<td style="line-height: 16px;">월∼토: 오전11시~오후8시<br>
			공휴일: 오후12시~오후8시<br> ※ 일요일은 휴무입니다
		</td>
	</tr>
	<tr class="service_center_middle_tr">
