		...
		<div id="main">
			<div class="il_area">
				<article class="il_1st">
					<form action="./itemList.do" id="il_search_form" onclick = "check();">
	 			...
	 			<article class="il_3rd">
					<table class="il_paging">
						...
						<%	
							...
							%>
								<td class="page_edge"><a href="itemList.do?pageNum=<%=startPage%>&pageCount=<%=pageCount%>">첫페이지</a></td>
								<td class="page_normal"><a href="itemList.do?pageNum=<%=startPage-5%>&pageCount=<%=pageCount%>">&lt;&lt;</a></td>
							<% 	
								for(i = startPage; (i<=startPage+4)&&(i<=pageCount);i++){
							%>	
								<td class="page_normal"><a href="itemList.do?pageNum=<%=i%>&pageCount=<%=pageCount%>" class="il_now_page"><%= i%></a></td>
							<%
								}
								
							%>
								<td class="page_normal"><a href="itemList.do?pageNum=<%=startPage+5%>&pageCount=<%=pageCount%>">&gt;&gt;</a></td>
								<td class="page_edge"><a href="itemList.do?pageNum=<%=pageCount%>&pageCount=<%=pageCount%>">끝페이지</a></td>
							<%
