...
public class SellingBoardVO { 
	...
	public String getEntitiy_number() {
		return entitiy_number;
	}
	public void setEntitiy_number(String entitiy_number) {
		this.entitiy_number = entitiy_number;
	}
